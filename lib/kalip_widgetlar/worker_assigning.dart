...
class WorkerAssigning extends StatefulWidget {
  ...
  @override
  _WorkerAssigningState createState() => _WorkerAssigningState(context,workarea);
}
...
class _WorkerAssigningState extends State<WorkerAssigning> {
  ...
  void initState() {
    ...
    super.initState();
      ...
      employedworker=Citizen.citizen.where((element)=>(element['workarea'].contains(workarea))).toList();
      unemployedworker=Citizen.citizen.where((element)=>(element['workarea'].contains('unemployed'))).toList();
    ...
    return  Stack(
      children: <Widget>[
        ...
        Positioned(
          ...
          child: ListView.builder(itemBuilder:(_, index){ return AssignedWorker(context,index);},
        ...
        Positioned(
          ...
          width: MediaQuery.of(context).size.width,
          height:MediaQuery.of(context).size.height*0.3,
          child: ListView.builder(itemBuilder:(_, index){ return AssignWorker(context,index);},
  ...
  Widget AssignedWorker (BuildContext context,int index){
    return GestureDetector(
      ...
      onTap: (){IstenCikarma(employedworker[index]['id']);},
    );
}
